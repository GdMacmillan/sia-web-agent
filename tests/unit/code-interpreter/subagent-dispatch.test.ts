// Ported from upstream @langchain/quickjs (libs/providers/quickjs/src/subagent-dispatch.test.ts).
// vitest -> @jest/globals. Logic verbatim.
import { describe, it, expect } from "@jest/globals";
import { validateResponseSchema } from "../../../src/code-interpreter/subagent-dispatch.js";
