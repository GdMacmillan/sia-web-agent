// Ported from upstream @langchain/quickjs (libs/providers/quickjs/src/transform.test.ts).
// vitest -> @jest/globals, import path rewritten. Logic verbatim.
import { describe, it, expect } from "@jest/globals";
import { transformForEval, stripTypeSyntax } from "../../../src/code-interpreter/transform.js";
