// Ported from upstream deepagents (libs/deepagents/src/permissions/enforce.test.ts).
// vitest -> @jest/globals, import path rewritten. Logic verbatim.
import { describe, it, expect } from "@jest/globals";
import { validatePath, globMatch, decidePathAccess } from "../../../src/permissions/enforce.js";
